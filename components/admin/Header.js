      ...
      <div className="px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
                ...
                <div className="absolute right-0 top-full mt-2 w-96 bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl z-50">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    ...
                    {Array.isArray(adminNotifications.pending_withdrawals) && adminNotifications.pending_withdrawals.map((item, idx) => (
                      <div key={`pw-${idx}`} onClick={() => { router.push('/admin/withdrawals'); setShowNotifications(false); }} className="p-4 hover:bg-white/5 border-b border-white/5 last:border-b-0 transition-colors cursor-pointer">
                    ...
                    {Array.isArray(adminNotifications.pending_forums) && adminNotifications.pending_forums.map((item, idx) => (
                      <div key={`pf-${idx}`} onClick={() => { router.push('/admin/forums'); setShowNotifications(false); }} className="p-4 hover:bg-white/5 border-b border-white/5 last:border-b-0 transition-colors cursor-pointer">
                        <div className="flex items-start gap-3">
                    ...
                    {Array.isArray(adminNotifications.new_users) && adminNotifications.new_users.map((item, idx) => (
                      <div key={`nu-${idx}`} onClick={() => { router.push('/admin/users'); setShowNotifications(false); }} className="p-4 hover:bg-white/5 border-b border-white/5 last:border-b-0 transition-colors cursor-pointer">
                        <div className="flex items-start gap-3">
            ...
            {/* Settings */}
            <button onClick={() => router.push('/admin/settings')} className="p-3 text-gray-400 hover:text-white hover:bg-white/10 rounded-xl transition-all duration-300">
              ...
              {showProfileMenu && (
                <>
                  <div className="absolute right-0 top-full mt-2 w-44 bg-gray-900/95 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl z-50 py-2">
                    <button onClick={() => { router.push('/admin/profile'); setShowProfileMenu(false); }} className="w-full text-left px-4 py-2 hover:bg-white/5 transition-colors">
                      Profile
                    </button>
                    <button onClick={() => {
