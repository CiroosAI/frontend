...
export default function TermsAndConditions() {
  ...
  return (
    <>
      <Head>
        <title>{applicationData?.name || 'Ciroos'} | Syarat dan Ketentuan</title>
        <meta name="description" content={`${applicationData?.name || 'Ciroos'} Syarat dan Ketentuan`} />
        ...
        <div className="relative z-10 pt-8 pb-6 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">Syarat dan Ketentuan</h1>
                  ...
                  <div className="space-y-6 text-sm leading-relaxed">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:file-document" className="w-6 h-6 text-[#F45D16]" />
                        Pengantar
                      </h2>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 text-white/80">
                        <p><strong>Aplikasi</strong> berarti program perangkat lunak yang disediakan oleh Perusahaan yang diunduh oleh Anda di perangkat elektronik apa pun, bernama Ciroos.</p>
                        ...
                        <p><strong>Situs Web</strong> mengacu pada Ciroos, dapat diakses dari https://ciroos.ca</p>
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:handshake" className="w-6 h-6 text-[#F45D16]" />
                        Pengakuan
                      </h2>
                      <div className="space-y-3 text-white/80">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:link" className="w-6 h-6 text-[#F45D16]" />
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:stop-circle" className="w-6 h-6 text-[#F45D16]" />
                        Penghentian
                      </h2>
                      <div className="space-y-3 text-white/80">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:shield-alert" className="w-6 h-6 text-[#F45D16]" />
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:alert-circle" className="w-6 h-6 text-[#F45D16]" />
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:gavel" className="w-6 h-6 text-[#F45D16]" />
                        Hukum yang Berlaku
                      </h2>
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:scale-balance" className="w-6 h-6 text-[#F45D16]" />
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:flag" className="w-6 h-6 text-[#F45D16]" />
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:file-cog" className="w-6 h-6 text-[#F45D16]" />
                        Pemisahan dan Pengabaian
                      </h2>
                      <div className="space-y-3 text-white/80">
                        <div>
                          <h4 className="font-semibold text-white mb-2">Pemisahan</h4>
                        ...
                        <div>
                          <h4 className="font-semibold text-white mb-2">Pengabaian</h4>
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                        <Icon icon="mdi:translate" className="w-6 h-6 text-[#F45D16]" />
