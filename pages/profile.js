...
export default function Profile() {
  ...
  const handleLogout = () => {
    // attempt to inform server to invalidate refresh token, but don't block logout
    try {
      logoutUser().catch(() => {});
    } catch (e) {}
    ...
    // Remove refresh_token cookie if set by client
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 pb-32">
      <Head>
  <title>{applicationData?.name || 'Vla Devs'} | Profile</title>
        ...
        <div className="bg-gradient-to-r from-purple-800/60 to-pink-600/60 backdrop-blur-xl rounded-3xl p-6 mb-6 border border-purple-400/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-4 relative z-10">
            ...
            <div className="text-center">
              ...
              <p className="text-purple-200 text-xs font-medium">{applicationData?.name || 'Vla Devs'}</p>
  ...
  {/* Download APK */}
  <div className="bg-gradient-to-br from-purple-800/50 to-pink-600/40 backdrop-blur-xl rounded-3xl p-5 mb-6 border border-purple-400/30 shadow-2xl text-center relative overflow-hidden flex flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-3 relative z-10">
            ...
            <h3 className="text-cyan-400 font-semibold">{applicationData?.name || 'PLATFORM'} APK</h3>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          >
            ...
            <div className="flex-1 text-left">
              <p className="font-semibold">Riwayat</p>
              <p className="text-xs text-purple-300">Penarikan</p>
            </div>
          </button>
          ...
          >
            <div className="w-10 h-10 bg-blue-600/30 rounded-xl flex items-center justify-center">
              <Icon icon="mdi:information" className="w-5 h-5 text-blue-300" />
            </div>
            <div className="flex-1 text-left">
              <p className="font-semibold">Tentang</p>
              <p className="text-xs text-purple-300">Kami</p>
            </div>
          </button>
        </div>
