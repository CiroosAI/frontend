        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10">
            <h3 className="text-white font-semibold mb-4 flex items-center gap-2">
              <Icon icon="mdi:target" className="w-5 h-5 text-[#0058BC]" />
              Tujuan Pendirian
            </h3>
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-center gap-3 p-3 bg-white/5 rounded-xl border border-white/10">
                  <Icon icon={item.icon} className="text-[#0058BC] w-5 h-5 flex-shrink-0" />
                  <div>
                    <span className="font-semibold text-white text-sm">{item.title}</span>
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10">
            <h3 className="text-white font-semibold mb-3 flex items-center gap-2">
              <Icon icon="mdi:lightbulb-on-outline" className="w-5 h-5 text-yellow-400" />
              Kesimpulan
            </h3>
            <p className="text-sm text-white/70 leading-relaxed">
