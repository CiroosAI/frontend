...
import { Home, Users, Gift, CreditCard, User, ArrowLeft, Plus, Check } from 'lucide-react';
...
export default function BankAdd() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 pb-24">
      <Head>
  <title>{applicationData?.name || 'Vla Devs'} | Tambah Rekening Bank</title>
  ...
  <link rel="icon" href="/logo.png" />
      ...
      <div className="bg-white/10 backdrop-blur-xl border-b border-white/20 sticky top-0 z-10">
        <div className="max-w-md mx-auto px-4 py-4 flex items-center">
          ...
          <div className="flex items-center gap-3 mx-auto">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">Tambah Rekening</h1>
            </div>
          </div>
      ...
      <div className="max-w-md mx-auto p-6">
        ...
        <div className="bg-gradient-to-r from-purple-600/30 to-pink-600/30 backdrop-blur-xl rounded-3xl p-6 border border-white/20 shadow-2xl mb-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 bg-white/20 rounded-2xl">
              <Icon icon="mdi:bank-plus" className="text-3xl text-white" />
            </div>
            <div>
              <h2 className="text-xl font-bold text-white">Rekening Baru</h2>
              <p className="text-white/70 text-sm">Tambahkan rekening untuk penarikan</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 border border-white/20 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full bg-white/10 border border-white/20 text-white rounded-2xl px-4 py-4 pr-12 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent appearance-none font-medium backdrop-blur-sm"
                  required
                >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 text-white rounded-2xl px-4 py-4 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent font-medium backdrop-blur-sm placeholder-white/50"
                  required
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 disabled:from-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-bold py-4 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-purple-500/25 hover:scale-105 active:scale-95 disabled:hover:scale-100"
            >
              {isSubmitting ? (
                <>
        ...
        {/* Info Card */}
        <div className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 backdrop-blur-xl rounded-3xl p-6 border border-white/20 shadow-xl mt-6">
          <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Icon icon="mdi:information-outline" className="text-blue-300" />
            Informasi Penting
          </h3>
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-white/80">Rekening harus aktif dan dapat menerima transfer</p>
            </div>
            <div className="flex items-start gap-3">
              <Icon icon="mdi:refresh" className="text-purple-400 mt-1 flex-shrink-0" />
              <p className="text-sm text-white/80">Periksa kembali data sebelum menambahkan</p>
            </div>
          </div>
        </div>
        {/* Copyright */}
