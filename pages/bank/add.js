        ...
        <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10 shadow-2xl mb-6 mt-2">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-[#0058BC] to-[#3D85C6] rounded-2xl flex items-center justify-center">
              <Icon icon="mdi:bank-plus" className="text-2xl text-white" />
            </div>
            <div>
              <h2 className="text-xl font-bold text-white">Rekening Baru</h2>
              <p className="text-white/60 text-sm">Tambahkan rekening untuk penarikan dana.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-700/10 to-indigo-600/10 rounded-2xl border border-blue-400/20 p-5 mt-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-white/80 leading-relaxed">Pastikan nama pemilik rekening sesuai dengan identitas Anda.</p>
            </div>
            <div className="flex items-start gap-3">
              <Icon icon="mdi:shield-check" className="text-blue-400 mt-1 flex-shrink-0" />
              <p className="text-sm text-white/80 leading-relaxed">Rekening harus aktif dan dapat menerima transfer.</p>
            </div>
            <div className="flex items-start gap-3">
              <Icon icon="mdi:refresh" className="text-purple-400 mt-1 flex-shrink-0" />
              <p className="text-sm text-white/80 leading-relaxed">Periksa kembali data sebelum menambahkan untuk menghindari kesalahan.</p>
            </div>
          </div>
        </div>
        {/* Copyright */}
