  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] pb-32 relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto p-4 relative z-10">
        {/* Intro Section */}
        <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10 shadow-2xl mb-6 mt-2 text-center">
          <div className="w-12 h-12 bg-gradient-to-br from-[#0058BC] to-[#3D85C6] rounded-2xl flex items-center justify-center mx-auto mb-3">
            <Icon icon="mdi:shield-lock" className="text-2xl text-white" />
          </div>
          <h2 className="text-xl font-bold text-white mb-1">Keamanan Akun</h2>
        ...
        <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10 shadow-2xl">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="•••••••"
                  className="flex-1 bg-transparent outline-none py-3.5 px-4 text-white placeholder-white/40"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 p-5 bg-gradient-to-br from-blue-700/10 to-indigo-600/10 rounded-2xl border border-blue-400/20">
            <h3 className="text-blue-200 font-semibold text-sm mb-4 flex items-center gap-2">
              <Icon icon="mdi:information-variant" className="text-blue-300" />
              Tips Keamanan Sandi
            </h3>
            <ul className="space-y-3 text-blue-200 text-xs">
              <li className="flex items-start gap-2">
                <Icon icon="mdi:check-circle-outline" className="text-green-400 mt-0.5 flex-shrink-0" />
