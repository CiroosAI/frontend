...
export default function Register() {
    ...
    if (storedApplication) {
      try {
        ...
        setApplicationData({
          ...
          company: parsed.company || 'Ciroos, Inc',
          healthy: parsed.healthy || false,
        });
      } catch (e) {
        setApplicationData({ name: 'Ciroos AI', company: 'Ciroos, Inc', healthy: false });
      }
    } else {
      setApplicationData({ name: 'Ciroos AI', company: 'Ciroos, Inc', healthy: false });
    }
  ...
  return (
    <>
      <Head>
        <title>{applicationData?.name || 'Ciroos AI'} | Register</title>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A] relative overflow-hidden py-12">
        ...
        <div className="relative z-10 w-full max-w-6xl px-6 py-12">
          <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
              ...
              <div className="space-y-6 hidden lg:block animate-fade-in-left">
                
                {/* Welcome Card */}
                <div className="glass-card p-8 rounded-3xl hover-lift">
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#F45D16]/20 to-[#0058BC]/20 flex items-center justify-center border border-[#F45D16]/30">
                      <Icon icon="mdi:rocket-launch" className="w-7 h-7 text-[#F45D16]" />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-[#FAF8F6] mb-2">Mulai Perjalanan Anda!</h3>
                      <p className="text-[#EDE5D9]/70 text-sm leading-relaxed">
                        Bergabunglah dengan ribuan investor yang sudah mempercayai platform kami untuk mengelola investasi mereka.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {/* Benefits Card */}
                <div className="glass-card p-8 rounded-3xl hover-lift">
                  <h4 className="text-lg font-bold text-[#FAF8F6] mb-6 flex items-center gap-2">
                    <Icon icon="mdi:gift" className="w-5 h-5 text-[#F45D16]" />
                    Keuntungan Bergabung
                  </h4>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#F45D16]/10 flex items-center justify-center shrink-0 border border-[#F45D16]/20">
                        <Icon icon="mdi:cash-multiple" className="w-5 h-5 text-[#F45D16]" />
                      </div>
                      <div>
                        <p className="text-[#FAF8F6] font-semibold text-sm">Bonus Pendaftaran</p>
                        <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Dapatkan bonus untuk member baru</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#0058BC]/10 flex items-center justify-center shrink-0 border border-[#0058BC]/20">
                        <Icon icon="mdi:account-supervisor" className="w-5 h-5 text-[#0058BC]" />
                      </div>
                      <div>
                        <p className="text-[#FAF8F6] font-semibold text-sm">Program Referral</p>
                        <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Ajak teman dan dapatkan komisi</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-xl bg-[#F45D16]/10 flex items-center justify-center shrink-0 border border-[#F45D16]/20">
                        <Icon icon="mdi:shield-star" className="w-5 h-5 text-[#F45D16]" />
                      </div>
                      <div>
                        <p className="text-[#FAF8F6] font-semibold text-sm">Akses Premium</p>
                        <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Fitur eksklusif untuk member</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="animate-fade-in-right">
                <div className="glass-card-primary p-8 lg:p-10 rounded-3xl">
                  
                  {/* Logo + Form Header */}
                  <div className="text-center mb-8">
                    {/* Logo Ciroos */}
                    <div className="relative mb-6">
                      <div className="absolute -inset-2 bg-gradient-to-r from-[#F45D16]/30 to-[#0058BC]/30 blur-xl rounded-full"></div>
                      <div className="relative w-32 h-32 mx-auto">
                        <Image
                          src="/logo_full.svg"
                          alt="Ciroos AI Logo"
                          className="w-full h-full object-contain drop-shadow-[0_0_25px_rgba(244,93,22,0.6)]"
                          width={128}
                          height={128}
                          priority
                          onError={(e) => {
                        ...
                        />
                        <div style={{ display: 'none' }} className="w-32 h-32 bg-gradient-to-br from-[#F45D16] to-[#0058BC] rounded-3xl flex items-center justify-center shadow-2xl border-2 border-white/20">
                          <Icon icon="mdi:alpha-c-circle" className="text-white w-20 h-20" />
                        </div>
                      </div>
                    </div>
                    
                    <h2 className="text-3xl font-bold text-[#FAF8F6] mb-2">Daftar Akun Baru</h2>
                    <p className="text-[#EDE5D9]/70 text-sm">Mulai perjalanan investasi Anda hari ini</p>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="name" className="block text-[#EDE5D9] text-sm font-semibold flex items-center gap-2">
                        ...
                        <div className="input-field-modern">
                          ...
                          <div className="px-4">
                            {formValidation.name ? (
                              ...
                              <Icon icon="mdi:account-outline" className="w-5 h-5 text-[#EDE5D9]/20" />
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Phone Number Field */}
                    <div className="space-y-2">
                      <label htmlFor="number" className="block text-[#EDE5D9] text-sm font-semibold flex items-center gap-2">
                      ...
                      <div className="relative group">
                        <div className="input-field-modern">
                          ...
                          <input
                            type="tel"
                            id="number"
                            className="flex-1 min-w-0 bg-transparent outline-none px-4 py-4 text-[#FAF8F6] placeholder-[#EDE5D9]/40 text-sm font-medium"
                          ...
                          <div className="flex items-center shrink-0 px-4">
                            {formValidation.number ? (
                              ...
                              <Icon icon="mdi:phone-outline" className="w-5 h-5 shrink-0 text-[#EDE5D9]/20" />
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    {/* Password Field */}
                    <div className="space-y-2">
                      <label htmlFor="password" className="block text-[#EDE5D9] text-sm font-semibold flex items-center gap-2">
                      ...
                      <div className="relative group">
                        ...
                        {formData.password && (
                          <div className="mt-2 space-y-2">
                            ...
                            <div className="text-xs text-[#EDE5D9]/60 flex items-center gap-2">
                              <Icon 
                    ...
                    <div className="space-y-2">
                      <label htmlFor="password_confirmation" className="block text-[#EDE5D9] text-sm font-semibold flex items-center gap-2">
                    ...
                    {/* Referral Code Field */}
                    <div className="space-y-2">
                      <label htmlFor="referral_code" className="block text-[#EDE5D9] text-sm font-semibold flex items-center gap-2">
                        ...
                        <div className={`input-field-modern ${referralLocked ? 'opacity-75' : ''}`}>
                          ...
                          <div className="px-4">
                            {referralLocked ? (
                              ...
                              <Icon icon="mdi:gift-outline" className="w-5 h-5 text-[#EDE5D9]/20" />
                            )}
                          </div>
                        </div>
                        {referralLocked && (
                    ...
                    <button
                      ...
                      className={`w-full font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg border relative overflow-hidden mt-8 ${
                        (!maintenanceMode && !closedRegister && isFormValid)
                          ? 'bg-gradient-to-r from-[#F45D16] to-[#FF6B35] hover:from-[#d74e0f] hover:to-[#F45D16] text-white border-[#F45D16]/30 hover:shadow-[0_0_40px_rgba(244,93,22,0.5)] hover:scale-[1.02] active:scale-[0.98]'
                  ...
                  <div className="relative my-8">
                    ...
                    <div className="relative flex justify-center text-xs">
                      <span className="px-4 text-[#EDE5D9]/50 bg-[#0A0A0A]/50 backdrop-blur-sm">atau</span>
                    </div>
                  </div>

                  {/* Login Link */}
                  <div className="text-center">
                    <p className="text-[#EDE5D9]/70 text-sm mb-4">Sudah punya akun?</p>
                    <Link href="/login">
                      <span className="inline-flex items-center gap-2 text-[#FAF8F6] font-semibold hover:text-[#F45D16] transition-colors duration-200 bg-white/5 px-6 py-3 rounded-xl hover:bg-white/10 cursor-pointer border border-white/10 hover:border-[#F45D16]/30">
            ...
            <div className="mt-12 animate-fade-in-up">
              <div className="glass-card px-6 py-3 rounded-full inline-flex items-center gap-2">
                <Icon icon="mdi:copyright" className="w-3.5 h-3.5 text-[#EDE5D9]/50" />
                <span className="text-[#EDE5D9]/50 text-xs">2025 {applicationData?.company || 'Ciroos, Inc'}. All Rights Reserved.</span>
              </div>
            </div>
        ...
        <style jsx global>{`
          ...
          .glass-card-primary {
            background: radial-gradient(94.23% 79.86% at 50% 31.48%, rgba(243, 250, 247, 0.04) 57%, rgba(243, 250, 247, 0.12) 91.5%);
          ...
          .input-field-modern:focus-within {
            border-color: #F45D16;
            background: rgba(244, 93, 22, 0.05);
            box-shadow: 0 0 0 4px rgba(244, 93, 22, 0.15);
          }
          ...
          .hover-lift:hover {
            ...
            box-shadow: 0 12px 40px rgba(244, 93, 22, 0.2);
            border-color: rgba(244, 93, 22, 0.3);
          }
