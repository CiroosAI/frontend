        ...
        <div className="grid grid-cols-1 gap-4 mb-5">
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-4 border border-white/10">
            <div className="flex items-center justify-between mb-3">
              ...
              >
                <Icon icon={copied.code ? "mdi:check" : "mdi:content-copy"} className="w-5 h-5" />
              </button>
            </div>
            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
              <p className="text-white font-mono font-bold text-center text-lg tracking-wider">
                {reffCode || '---'}
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-4 border border-white/10">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <Icon icon="mdi:link-variant" className="w-5 h-5 text-[#0058BC]" />
                <span className="text-white font-semibold text-sm">Link Referral</span>
              </div>
              <button
              ...
              >
                <Icon icon={copied.link ? "mdi:check" : "mdi:share-variant"} className="w-5 h-5" />
              </button>
            </div>
            <div className="bg-white/5 rounded-xl p-3 border border-white/10">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-white font-bold text-sm mb-0.5">Level 1 Direct</h3>
                      <div className="flex items-center gap-3 text-xs">
                        <span className="text-white/60">{teamStats[1]?.count || 0} Tim</span>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            ...
            <div className="flex-shrink-0 w-64 bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-4 border border-white/10">
              <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center mb-3">
                <Icon icon="mdi:chart-line" className="w-6 h-6 text-green-400" />
              </div>
              <h4 className="text-white font-bold text-sm mb-2">Passive Income</h4>
              <p className="text-white/60 text-xs leading-relaxed">
                Penghasilan pasif dari jaringan yang terus berkembang
              </p>
            </div>

            <div className="flex-shrink-0 w-64 bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-2xl p-4 border border-white/10">
              <div className="w-10 h-10 rounded-xl bg-[#0058BC]/10 flex items-center justify-center mb-3">
                <Icon icon="mdi:lightning-bolt" className="w-6 h-6 text-[#0058BC]" />
              </div>
              <h4 className="text-white font-bold text-sm mb-2">Pencairan Cepat</h4>
              <p className="text-white/60 text-xs leading-relaxed">
                Proses withdrawal mudah dan cepat setiap saat
              </p>
            </div>
          </div>
        </div>
