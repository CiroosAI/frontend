      ...
      <div className="max-w-sm mx-auto p-4 relative z-10">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-3xl p-5 border border-white/10">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="text-center p-3 bg-gradient-to-br from-[#F45D16]/10 to-[#FF6B35]/10 rounded-xl border border-[#F45D16]/20">
                <p className="text-xs text-white/60 mb-1">Tiket Spin</p>
                <p className="text-lg font-bold text-[#F45D16]">{userData.spin_ticket}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex justify-center p-4">
            <div className="relative w-72 h-72">
              ...
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2 z-20 flex flex-col items-center pointer-events-none">
                <div className={`w-0 h-0 border-l-[16px] border-r-[16px] border-t-[24px] border-l-transparent border-r-transparent drop-shadow-lg transition-all duration-300 ${pointerActive ? 'border-t-yellow-400 scale-110' : 'border-t-[#F45D16]'}`}></div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className={`w-full bg-gradient-to-r from-[#F45D16] to-[#FF6B35] text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 shadow-lg shadow-[#F45D16]/30 mb-4 ${
              isSpinning || userData.spin_ticket < 1 ? 'opacity-50 cursor-not-allowed' : 'hover:from-[#d74e0f] hover:to-[#F45D16] hover:shadow-[#F45D16]/50 hover:scale-[1.02] active:scale-[0.98]'
            }`}
          >
            {isSpinning ? (
              <>
