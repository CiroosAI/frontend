  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center">
        <Head>
  <title>{applicationData?.name || 'Vla Devs'} | Spin Wheel</title>
        ...
        <div className="bg-gradient-to-br from-purple-800/40 to-pink-600/30 backdrop-blur-xl rounded-3xl p-6 border border-purple-400/20 shadow-2xl">
          ...
          <div className="grid gap-3">
            {prizes.map((prize, index) => (
              <div
                key={index}
                className="flex items-center p-4 rounded-2xl bg-black/20 backdrop-blur-sm border border-purple-400/20"
              >
