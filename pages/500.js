    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative w-32 h-32 mx-auto bg-gradient-to-br from-[#1A1A1A] to-[#0F0F0F] rounded-full border border-white/10 flex items-center justify-center">
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-2xl p-5 border border-white/10 mb-6">
          ...
          <div className="h-1 bg-white/5 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#F45D16] to-[#FF6B35] transition-all duration-1000"
          ...
          <button
            ...
            className={`flex items-center justify-center gap-2 py-4 rounded-xl font-bold transition-all duration-300 ${
              isRetrying
                ...
                : 'bg-gradient-to-r from-[#F45D16] to-[#FF6B35] hover:from-[#d74e0f] hover:to-[#F45D16] text-white shadow-lg hover:scale-[1.02] active:scale-[0.98]'
            }`}
          >
            <Icon 
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/[0.02] rounded-2xl p-4 border border-white/10">
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2 text-white/60 text-xs">
              <Icon icon="mdi:check" className="w-4 h-4 text-[#F45D16] mt-0.5 flex-shrink-0" />
