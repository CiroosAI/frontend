                    ...
                    <div className="glassmorphism-card rounded-3xl p-8 shadow-2xl animate-fadeIn">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 animate-slideUp">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="flex items-center input-field">
                                        <div className="flex items-center shrink-0 px-4 py-3.5">
                                        ...
                                        <input
                                            type="tel"
                                            id="number"
                                            className="flex-1 min-w-0 bg-transparent outline-none px-2 py-3.5 text-[#FAF8F6] placeholder-[#EDE5D9]/50 text-sm"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    <div className="flex items-center input-field">
                                        <Icon icon="mdi:lock" className="px-4 text-[#EDE5D9]/70 w-5 h-5" />
                                        <input
                                            type={showPassword ? "text" : "password"}
                                            id="password"
                                            className="flex-1 bg-transparent outline-none px-2 py-3.5 text-[#FAF8F6] placeholder-[#EDE5D9]/50 text-sm"
                                        ...
                                        <button
                                            ...
                                            className="px-4 text-[#EDE5D9]/70 hover:text-[#FAF8F6] transition-colors"
                                        >
                                            <Icon
