        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A] relative overflow-hidden">
                        ...
                        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
                                ...
                                <div className="glass-card p-8 rounded-3xl hover-lift">
                                    <div className="flex items-start gap-4 mb-4">
                                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#F45D16]/20 to-[#0058BC]/20 flex items-center justify-center border border-[#F45D16]/30">
                                            <Icon icon="mdi:hand-wave" className="w-7 h-7 text-[#F45D16]" />
                                        </div>
                                        <div className="flex-1">
                                            <h3 className="text-xl font-bold text-[#FAF8F6] mb-2">Selamat Datang Kembali!</h3>
                                            <p className="text-[#EDE5D9]/70 text-sm leading-relaxed">
                                                Masuk untuk mengakses dashboard investasi dan kelola portofolio Anda dengan mudah.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="glass-card p-8 rounded-3xl hover-lift">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-[#FAF8F6] font-semibold text-sm">Real-time Analytics</p>
                                                <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Monitor investasi secara langsung</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <div className="w-10 h-10 rounded-xl bg-[#0058BC]/10 flex items-center justify-center shrink-0 border border-[#0058BC]/20">
                                                <Icon icon="mdi:shield-lock" className="w-5 h-5 text-[#0058BC]" />
                                            </div>
                                            <div>
                                                <p className="text-[#FAF8F6] font-semibold text-sm">Keamanan Terjamin</p>
                                                <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Enkripsi data tingkat enterprise</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <div className="w-10 h-10 rounded-xl bg-[#F45D16]/10 flex items-center justify-center shrink-0 border border-[#F45D16]/20">
                                                <Icon icon="mdi:account-group" className="w-5 h-5 text-[#F45D16]" />
                                            </div>
                                            <div>
                                                <p className="text-[#FAF8F6] font-semibold text-sm">Support 24/7</p>
                                                <p className="text-[#EDE5D9]/60 text-xs mt-0.5">Tim siap membantu kapan saja</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="animate-fade-in-right">
                                <div className="glass-card-primary p-8 lg:p-10 rounded-3xl">
                                    ...
                                    {/* Register Link */}
                                    <div className="text-center">
                                        <p className="text-[#EDE5D9]/70 text-sm mb-4">Belum punya akun?</p>
                                        <Link href="/register">
                ...
                <style jsx global>{`
                    ...
                    /* Simple fade in animations - NO floating */
                    @keyframes fadeInUp {
                        from {
                            opacity: 0;
